#ifndef FLUTTER_PLUGIN_BIOMETRIC_STORAGE_PLUGIN_H_
#define FLUTTER_PLUGIN_BIOMETRIC_STORAGE_PLUGIN_H_
...
FLUTTER_PLUGIN_EXPORT GType biometric_storage_plugin_get_type();
